...
class CreateProlongamentosTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('prolongamentos', function (Blueprint $table) {
            $table->string('id');
            $table->bigInteger('sector_id')->unsigned();
            $table->bigInteger('user_id')->unsigned();
            $table->enum('tipo_colaborador', ['Efectivo', 'Prestador']);
            $table->enum('tipo', ['Prolongamento de turno']);
            ...
            $table->enum('estado', ['Lido', 'Nao lido', 'Respondido'])->default('Nao lido');
    ...
    {
        Schema::dropIfExists('prolongamentos');
    }
}
