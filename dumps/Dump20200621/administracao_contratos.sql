...
CREATE TABLE `contratos` (
  ...
  `area_formacao` varchar(45) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `tipo_id` enum('CPS','CT') COLLATE utf8mb4_unicode_ci DEFAULT 'CPS',
  PRIMARY KEY (`id`),
...
-- Dump completed on 2020-06-21 18:05:03
