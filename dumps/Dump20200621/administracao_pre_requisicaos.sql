...
CREATE TABLE `pre_requisicaos` (
  ...
  `estado` enum('pendente','andamento','entregue','atrasada') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pendente',
  ...
  KEY `pre_requisicaos_local_id_foreign` (`local_id`),
  CONSTRAINT `pre_requisicaos_local_id_foreign` FOREIGN KEY (`local_id`) REFERENCES `locals` (`id`) ON DELETE CASCADE,
...
-- Dump completed on 2020-06-21 18:05:12
